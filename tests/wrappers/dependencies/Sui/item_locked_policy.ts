...
let MODULE_NAME: string = "item_locked_policy";
...
function set < T0 extends StructClass > (type_args: string[], arg0: TransferPolicy, arg1: TransferPolicyCap) {
    let wasm = get_wasm();
...
function prove < T0 extends StructClass > (type_args: string[], arg0: TransferRequest, arg1: Kiosk) {
    let wasm = get_wasm();
    ...
    arg0.from(arg0.from_bcs_t(new Uint8Array(a0.Raw[0])) as TransferRequest);
}

export const item_locked_policy = {
    Rule,
    unit_test_poison,
    set,
    prove
