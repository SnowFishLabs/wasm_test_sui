...
function length < T0 extends StructClass, T1 extends StructClass > (type_args: string[], arg0: ObjectTable): [Uint8Array] {
    let wasm = get_wasm();
...
function borrow < T0 extends StructClass, T1 extends StructClass > (type_args: string[], arg0: ObjectTable, arg1: T0): [Uint8Array] {
    let wasm = get_wasm();
...
function borrow_mut < T0 extends StructClass, T1 extends StructClass > (type_args: string[], arg0: ObjectTable, arg1: T0): [Uint8Array] {
    let wasm = get_wasm();
    ...
    arg0.from(arg0.from_bcs_t(new Uint8Array(a0.Raw[0])) as ObjectTable);
    return [
        new Uint8Array(r0.Raw[0])
    ];
}

function destroy_empty < T0 extends StructClass, T1 extends StructClass > (type_args: string[], arg0: ObjectTable) {
    let wasm = get_wasm();
...
function is_empty < T0 extends StructClass, T1 extends StructClass > (type_args: string[], arg0: ObjectTable): [Uint8Array] {
    let wasm = get_wasm();
...
function contains < T0 extends StructClass, T1 extends StructClass > (type_args: string[], arg0: ObjectTable, arg1: T0): [Uint8Array] {
    let wasm = get_wasm();
...
function remove < T0 extends StructClass, T1 extends StructClass > (type_args: string[], arg0: ObjectTable, arg1: T0): [Uint8Array] {
    let wasm = get_wasm();
...
function add < T0 extends StructClass, T1 extends StructClass > (type_args: string[], arg0: ObjectTable, arg1: T0, arg2: T1) {
    let wasm = get_wasm();
...
function value_id < T0 extends StructClass, T1 extends StructClass > (type_args: string[], arg0: ObjectTable, arg1: T0): [Uint8Array] {
    let wasm = get_wasm();
