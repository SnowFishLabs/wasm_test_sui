...
let MODULE_NAME: string = "malicious_policy";
...
function cheat < T0 extends StructClass > (type_args: string[], arg0: TransferRequest) {
    let wasm = get_wasm();
    ...
    let [a0] = wasm.call_return_bcs(PACKAGE_ADDRESS, MODULE_NAME, "cheat", type_args, args);
    arg0.from(arg0.from_bcs_t(new Uint8Array(a0.Raw[0])) as TransferRequest);
}

export const malicious_policy = {
    Rule,
    unit_test_poison,
    cheat
}